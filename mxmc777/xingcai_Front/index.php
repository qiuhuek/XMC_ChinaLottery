        ...
        <div class="sub_ScorllCont">
            ...
            <div class="index-menu">
                <ul>
                    ...
                    <li>
                        <a href="/" target="_blank"><img src="assets/statics/images/index_kefu.png"></a>
                    </li>
                </ul>
            </div>
                ...
                <ul>
                    ...
                    <li>
                        <a href="/index.php/index/game/60">
                            <div class="hot-icon icon_idx_0"><img class="" src="assets/statics/images/icon/4.png"></div>
                            <p class="hot-text text_idx_0">天津时时彩</p>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/index.php/index/game/87">
                            <div class="hot-icon icon_idx_0"><img class="" src="assets/statics/images/icon/3.png"></div>
            ...
            <div id="win_list" direction="up" >
                <div class="news-info">
                    <ul>
                        ...
                        ?>
                            <li>
                                <div class="news-left"><span class="pol-icon"></span><?php $name ?></div>
                                <div class="news-center c-red">喜中<?php $val['bonus']?>元</div>
                               <div class="news-right fr">购买<?php $val['shortName'] ?></div>
                            </li>
                        <?php } ?>
