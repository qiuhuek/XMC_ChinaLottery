...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript" src="./files/unslider.min.js"></script>
		<script src="./files/_user_.js"></script>
...
<script type="text/javascript" src="/skin/layer/layer.js"></script>
		...
		<!--<script type="text/javascript" src="./files/_home_menu.js"></script>-->
		...
		<div class="header-plus" id="header_plus">
			<div class="header-toptray-plus">
				<div class="quick-tpis">
					<div>您好,欢迎来到彩38!</div>
					<div class="top_dr_zc">
                        <a class="top_qdr" onclick="__openWin('login','/index.php/user/login')">请登录</a>
                        |
                        <a class="top_ljdr" onclick="__openWin('reg','/register/index.html')">立即注册</a>
                    </div>
					<div class="header-right fr">
						...
						<ul class="header-top-right fr ">
							<li><a id="play_free" onclick="jjtc();" style="display: none;">免费试玩</a></li>
							<li><a id="agent_reg_url" class="right-border" onclick="jjtc();" style="display: none;">加入代理</a></li>
							<li><a id="shoucang" class="right-border">加入收藏</a></li>
							<li><a class="right-border " onclick="');">帮助中心</a></li>
							<li><a class="right-border" onclick="')">玩法</a></li>
							<li><a target="_self" href="">资讯</a></li>
						</ul>
					</div>
					...
					<div class="wrapper clearfix relative">
								...
								<div class="top_login">
									<div style="float:right;">
										...
										<div style="float: left;margin-top: 1px">
											<input style="margin-right: 14px;" class="dr_anniu" onclick="userLogin();" type="button" name="login" value="登录">
											<input class="dr_anniu reg_anniu" type="button" onclick="__openWin('reg','/register/index.html')" value="注册">
										</div>
									</div>
						...
						<div id="header_user" class="logxinxi" hidden="" style="display: block;">
							<div class="top_login">
								...
								<span>可用余额：</span>
								<span><a class="balance colorRed" id="a_show_money" rel="nofollow"><span id="balance" class="orange">￥0.000</span></a>
								</span>
...
<div class="lotterys-list-hd" id="lotterysList" style="display:block">
  <ul class="lottery-list-box" id="lottery-list-box">
    <li class="mainGame">
      ...
      <div class="fl">
        <a onclick="__openWin('user_center','/index.php/index/game/86/2/12/三分时时彩');" class="mainA">
          <span class="color333">三分时时彩</span>
          <p onclick="__openWin('user_center','/index.php/index/game/86/2/12/三分时时彩');" target="_blank" class="status-desc"></p>
        </a>
      </div>
    </li>
    <li class="mainGame">
      <a onclick="__openWin('user_center','/index.php/index/game/1/2/12/重庆时时彩');" class="mainA">
        <i class="icon nav40-9">
      ...
      <div class="fl">
        <a onclick="__openWin('user_center','index.php/index/game/1/2/12/重庆时时彩');" class="mainA">
          ...
          <p onclick="__openWin('user_center','index.php/index/game/1/2/12/重庆时时彩');" target="_blank" class="status-desc">最火爆的快彩</p></a>
      </div>
    </li>
    <li class="mainGame">
      <a onclick="__openWin('user_center','/index.php/index/game/20/27/北京PK拾');" class="mainA">
        <i class="icon nav40-9">
    ...
    <li class="mainGame">
      <a onclick="__openWin('user_center','/index.php/index/game/80/104/339/幸运28');" class="mainA">
        <i class="icon nav40-9">
    ...
    <li class="mainGame">
      <a onclick="__openWin('user_center','/index.php/index/game/85/27/三分PK10');" class="mainA">
        <i class="icon nav40-9">
    ...
    <li class="mainGame">
      <a onclick="__openWin('user_center','/index.php/index/game/34/香港⑥合彩');" class="mainA">
        <i class="icon nav40-9">
      ...
      <div class="fl">
        <a onclick="__openWin('user_center','/index.php/index/game/34/香港⑥合彩');" class="mainA">
          ...
          <p onclick="__openWin('user_center','/index.php/index/game/34/香港⑥合彩');" target="_blank" class="status-desc">每周开奖三期</p></a>
      </div>
    </li>
    <li class="allGames clearfix" data-type="1">
      ...
      <ul class="clearfix game-list">
        <li>
          <a onclick="__openWin('user_center','/index.php/index/game/86/2/12/三分时时彩');">三分时时彩</a></li>
        <li>
          <a onclick="__openWin('user_center','/index.php/index/game/1/2/12/重庆时时彩');">重庆时时彩</a></li>
        <li>
          <a onclick="__openWin('user_center','/index.php/index/game/20/27/北京PK拾');">北京PK拾</a></li>
        <li>
          <a onclick="__openWin('user_center','/index.php/index/game/80/104/339/幸运28');">幸运28</a></li>
        <li>
          <a onclick="__openWin('user_center','/index.php/index/game/85/27/三分PK10');">三分PK拾</a></li>
        <li>
          <a onclick="__openWin('user_center','/index.php/index/game/87');">上海时时乐</a></li>
      </ul>
          ...
          <div class="otherGames num-games">
            ...
            <ol>
              ...
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/87');">上海时时乐</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/60/2/12/天津时时彩');">天津时时彩</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/12/2/12/新疆时时彩');">新疆时时彩</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/79/39/江苏快三');">江苏快三</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/7/10/山东11选5');">山东11选5</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/15/10/上海11选5');">上海11选5</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/16/10/江西11选5');">江西11选5</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/6/10/广东11选5');">广东11选5</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/82/39/广西快三');">广西快三</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/83/104/339/北京28');">北京28</a></li>
              <li>
                <a onclick="__openWin('user_center','/index.php/index/game/81/39/安徽快三');">安徽快三</a></li>
            </ol>
          </div>
        </div>
      </div>
			...
			<li>
			  <a onclick="__openWin('user_center','/index/game/10/排列3');">排列三</a></li>
						...
						<ul class="nav-plus clearfix">
							...
							<li><a onclick="__openWin('user_center','/index.php/lottery/hemai');" target="_blank">合买大厅</a></li>
							<li><a onclick="jjtc();" target="_blank"><i class="icon-iphone-icon"></i>&nbsp;手机购彩</a><em style="z-index: 9;right: -11px;" class="hot-icon"></em></li>
							<li><a onclick="__openWin('user_center','/index.php/event/index');">优惠活动</a><em class="hot-icon"></em></li>
							<li><a onclick="jjtc();" class="dropdown-desc">开奖公告</a></li>
							<li><a onclick="jjtc();">走势图表</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="wrap-bg">
					<div class="wrapper">
						<div class="submain">
							...
							<marquee id="sys_tip" behavior="scroll">尊敬的大地彩票贵宾，经过公司多方努力，现微信支付已经开放【长按二维码识别】进行支付，请将二维码保存至【相册】，再长按识别进行支付，单笔最高支持2万元，欢迎您体验！   彩38彩票：尊敬的彩38贵宾，现已推出QQ钱包扫码快捷支付，请点击【微信支付】，选择【QQ钱包扫一扫】进行获取二维码，再使用QQ扫码即可完成支付，期待您的加入。APP下载网址（C16.COM）   欢迎光临彩38投注网www.c16.com，全部彩种网上开始销售，下载手机APP注册会员赠送16元彩金，加入彩38，天天添彩添财，投注梦想，注定精彩！&nbsp;&nbsp;   </marquee></div>
							<div class="home-wrapper">
								<div class="quick-buy-box">
									<div name="content" class="qb qb-box-list" id="_index_countdownIssue">
										...
										<div class="qb-tz-box clearfix">
											...
											<div class="dg-btn-box">
                                                ...
                                                <a name="doBet" class="dg-tz-btn icon" id="fc3d_submit_index">立即投注</a>
                                            </div>
										</div>
									...
									<div class="help-tab-box">
										...
										<ul class="web-notice-box help-ul" id="cont_help_hot" style=""><li><a onclick="__openWin('home2','/index/newsContent.html?skey=DF42E62C-61A1-F85A-D3DA-7BD08D161FCE')">通知：有任何问题请咨询在线...</a></li></ul>
										<ul class="user-help-box help-ul" id="cont_help_newer" style="display: none;">
											<li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-1')">如何注册成为大地会员？</a></li>
											<li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-3')">忘记登录密码了怎么办？</a></li>
											<li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-7')">在网站充值要手续费吗？</a></li>
										</ul>
										<div class="helr_ruhe">
											<span>如何：</span>
											<a onclick="__openWin('login','/register/index.html');">注册 ＞ </a>
											<a onclick="__openWin('user_center','/index/lobby.html');">购彩 ＞ </a>
											<a onclick="if($('#balance').html().length &lt; 2)alert('您未登录,请登录后再进行操作!');else __openWin('user_center','/deposit/index.html');">充值 ＞ </a>
											<a onclick="if($('#balance').html().length &lt; 2)alert('您未登录,请登录后再进行操作!');else  __openWin('user_center','/withdraw/index.html');">提款</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="lottery-news-box">
								...
								<div class="news-bar">
									<div class="news-bar-content" id="news-bar-content1">
										<ul class="news-bar-list news-bar-left clearfix"><li><a onclick="__openWin('home2','/news/detail.html?key=3425')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3425')">吉林福彩“快3”大派奖 2600万奖金等您抢</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3424')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3424')">铁杆粉丝“豹子控” 倍投赢六千双11购物金</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3423')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3423')">无锡快3彩民有万全之策 喜中豹子奖2万7</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3422')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3422')">研究“和值 跨度” 浙江绍兴彩民中排列3万元</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3421')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3421')">11选5”中奖达人 小复式120倍斩获6万多</a> </li></ul>
									</div>
								</div>
							</div>
							<div class="lottery-news-box">
								...
								<div class="news-bar">
									<div class="news-bar-content" id="news-bar-content2">
										<ul class="news-bar-list news-bar-left clearfix"><li><a onclick="__openWin('home2','/news/detail.html?key=3420')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3420')">三位得主各用奇招中福彩大奖 却有一个共同点</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3419')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3419')">投注好技巧 彩民时隔十天再擒福彩3D万元大奖</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3418')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3418')">沭阳老彩民灵感浮现 喜中福彩3D大奖四万多元</a> </li><li><a onclick="__openWin('home2','/news/detail.html?key=3417')" class="c-grey">新闻</a><span class="pad c-grey">|</span> <a onclick="__openWin('home2','/news/detail.html?key=3417')">不打无准备之仗 美女复式选号收获福彩3D大奖</a> </li></ul>
									</div>
								</div>
							</div>
						</div>
								...
								<div>
									...
									<div class="notice-main">
										...
										<div class="draw-contents" id="tab-cont-1" style="">
											<ul class="notice-list" id="lastOpenSsc"><li><div><span class="lot-name"><a onclick="__openWin('user_center','/gameSsl/index.html')">上海时时乐&nbsp;</a>0627007期</span><span class="term">06-27</span><span class="clear"></span><div class="clear"></div><div class="redball">4</div><div class="redball">0</div><div class="redball">1</div><br><div class="fr"><a onclick="__openWin('lottery_trend','/trend/index.html?gameId=3&amp;periods=30');">走势</a>　|　<a onclick="__openWin('user_center','/gameSsl/index.html');">投注</a></div><div class="clear"></div></div></li><li><div><span class="lot-name"><a onclick="__openWin('user_center','/game/tjssc.html')">天津时时彩&nbsp;</a>0627029期</span><span class="term">06-27</span><span class="clear"></span><div class="clear"></div><div class="redball">5</div><div class="redball">4</div><div class="redball">3</div><div class="redball">7</div><div class="redball">7</div><br><div class="fr"><a onclick="__openWin('lottery_trend','/trend/index.html?gameId=4&amp;periods=30');">走势</a>　|　<a onclick="__openWin('user_center','/game/tjssc.html');">投注</a></div><div class="clear"></div></div></li><li><div><span class="lot-name"><a onclick="__openWin('user_center','/game/cqssc.html')">重庆时时彩&nbsp;</a>0627047期</span><span class="term">06-27</span><span class="clear"></span><div class="clear"></div><div class="redball">7</div><div class="redball">8</div><div class="redball">8</div><div class="redball">8</div><div class="redball">8</div><br><div class="fr"><a onclick="__openWin('lottery_trend','/trend/index.html?gameId=5&amp;periods=30');">走势</a>　|　<a onclick="__openWin('user_center','/game/cqssc.html');">投注</a></div><div class="clear"></div></div></li><li><div><span class="lot-name"><a onclick="__openWin('user_center','/game/xjssc.html')">新疆时时彩&nbsp;</a>0627023期</span><span class="term">06-27</span><span class="clear"></span><div class="clear"></div><div class="redball">8</div><div class="redball">0</div><div class="redball">9</div><div class="redball">7</div><div class="redball">3</div><br><div class="fr"><a onclick="__openWin('lottery_trend','/trend/index.html?gameId=7&amp;periods=30');">走势</a>　|　<a onclick="__openWin('user_center','/game/xjssc.html');">投注</a></div><div class="clear"></div></div></li><li><div><span class="lot-name"><a onclick="__openWin('user_center','/elevenGame/gd.html')">广东11选5&nbsp;</a>0627029期</span><span class="term">06-27</span><span class="clear"></span><div class="clear"></div><div class="redball">06</div><div class="redball">05</div><div class="redball">04</div><div class="redball">03</div><div class="redball">10</div><br><div class="fr"><a onclick="__openWin('lottery_trend','/trend/index.html?gameId=15&amp;periods=30');">走势</a>　|　<a onclick="__openWin('user_center','/elevenGame/gd.html');">投注</a></div><div class="clear"></div></div></li></ul>
										</div>
										<!-- 低频彩 -->
										<div class="draw-contents" id="tab-cont-2" style="display: none;">
											<ul class="notice-list" id="lastOpenQt"></ul>
										</div>
									</div>
								</div>
							</div>
        ...
        <div class="cnRight">
            <div class="cnTop">
               ...
               <div class="cn-list">
                    <h3>&nbsp;&nbsp;账户相关</h3>
                    <ul>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-1');" title="">如何注册账号</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-3')" title="">怎么找回登录密码</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-37')" title="">如何修改手机号码</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-26')" title="">如何修改真实姓名</a></li>
                    </ul>
                </div>
                <div class="cn-list">
                    <h3>&nbsp;&nbsp;充值购彩</h3>
                    <ul>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-tit3')" title="">如何进行充值</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-tit4')" title="">如何购买彩票</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-9')" title="">如何查询购彩记录</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-tit3')" title="">充值没到账怎么办</a></li>
                    </ul>
                </div>
                <div class="cn-list">
                    <h3>&nbsp;&nbsp;兑奖提款</h3>
                    <ul>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-10')">怎样进行兑奖</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-12')">如何进行提款</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-13')">提款是否收手续费</a></li>
                        <li><a onclick="__openWin('home_help','/helpCenter/helpInfo.html#help-16')">提款不成功怎么办</a></li>
                    </ul>
                </div>
                <div class="cn-list service">
                    <h3>&nbsp;&nbsp;APP下载</h3>
...
<div id="_leftAD" class="_float_AD l_AD">
    ...
    <div class="two_img"><img src="./files/getIosPng.html"></div>
</div>
<div id="_rightAD" class="_float_AD r_AD">
    ...
    <div class="two_img"><img src="./files/getAndroidPng.html"></div>
</div>
<script type="text/javascript">
...
//     $('#header_box>.nav-plus').on('click','li',function(){
//         $(this).addClass('on');
	...
	$.ajax({
		...
		success : function(data){
			...
			$.each(jsonarray, function (i, n)
			{
				//alert(n.Price);
				//<p><span><span class="bg_green">18</span>she***</span><span class="orange">137.2元</span></p>
				//<p><span class="bg_green">3</span>qq123<span class="orange">1940.000</span></p>
