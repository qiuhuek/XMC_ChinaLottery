		        ...
		        <div class="ac_list">
		            <div id="act_1" style="display: block;">
		                ...
		                <div id="activity_5" class="xialawz" style="display: none;">
							...
							<span style="font-weight: 700;"><strong><span style="color: rgb(255, 255, 0);">彩38</span></strong></span>
		                    ...
		                    <td>
		                        <div class="td_wrapper">
		                            ...
		                            <ul class="info">
		                                <li class="rules"><a></a></li>
		                                <li class="applicable"><em></em>活动对象：<span class="grey">所有会员</span></li>
		                                <li class="date"><em></em>活动内容：<span class="grey">彩38欢迎您</span></li>
		                            </ul>
		                            <a class="join">查看详情</a>
		                        </div>
		                    </td>
