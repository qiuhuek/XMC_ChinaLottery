...
//后三组合
exports.sxwfH3zh = function(bet, kj) {

    }
    //前三组合
exports.sxwfQ3zh = function(bet, kj) {
...
exports.sxwfH3hz = function(bet, kj) {
        ...
        kj = kj.split(',');
        bet = bet.split(',');
        var m = (parseInt(kj[2]) + parseInt(kj[3]) + parseInt(kj[4]));
...
// 后三组3和值
exports.sxz3H3hz = function(bet, kj) {
        kj = kj.split(',');
        bet = bet.split(',');
        var bz = kj.join();
        if (bz.match(/(\d),\1,\1/)) return 0;
...
// 后三组6和值
exports.sxz6H3hz = function(bet, kj) {
        kj = kj.split(',');
        bet = bet.split(',');
        var bz = kj.join();
        if (bz.match(/(\d),\1,\1/)) return 0;
        ...
        for (var i = 0; i < bet.length; i++) {
            if (m == bet[i]) {
                if ((parseInt(kj[0]) != parseInt(kj[1])) && (parseInt(kj[2])!=parseInt(kj[1]))) {
                    return 1;
                    break;
                }
            }
...
exports.sscq2zxkd = function(bet, kj) {
        ...
        kj = kj.split(',');
        bet = bet.split(',');
		var m = Math.abs(parseInt(kj[0]) - parseInt(kj[1]));
		for (i = 0; i < bet.length; i++) {
			if (bet[i] == m) k += 1;
		}
		return k;
...
exports.rxzxH2d = function(bet, kj) {
    ...
    // 任二直选和值
exports.rxwfR2zxhz = function(bet, kj, w) {
    kj = kj.split(',');
    [16, 8, 4, 2, 1].forEach(function(v, i) {
        if ((w & v) == 0) delete kj[i];
    });
    ...
    // 任二组选和值
exports.rxwfR2zuxhz = function(bet, kj, w) {
	kj = kj.split(',');
    [16, 8, 4, 2, 1].forEach(function(v, i) {
        if ((w & v) == 0) delete kj[i];
    });
    ...
    bet = bet.split(',');
    var m = (parseInt(kj[0]) + parseInt(kj[1]));
	if(parseInt(kj[0]) === parseInt(kj[1]))return 0;
    for (i = 0; i < bet.length; i++) {
        if (bet[i] == m) k += 1;
    }
    return k;
    ...
    // 任三直选和值
exports.rx3zxhz = function(bet, kj) {
    kj = kj.split(',');
    [16, 8, 4, 2, 1].forEach(function(v, i) {
        if ((w & v) == 0) delete kj[i];
    });
    ...
    // 任三组选和值
exports.rx3zuxhz = function(bet, kj) {
	kj = kj.split(',');
    [16, 8, 4, 2, 1].forEach(function(v, i) {
        if ((w & v) == 0) delete kj[i];
    });
    ...
    bet = bet.split(',');
    var m = (parseInt(kj[0]) + parseInt(kj[1]) + parseInt(kj[2]));
	if((parseInt(kj[0]) === parseInt(kj[1])) && parseInt(kj[0]) === parseInt(kj[2]) )return 0;
    for (i = 0; i < bet.length; i++) {
        if (bet[i] == m) k += 1;
    }
    return k;
    ...
    // 任三组三单式
exports.rx3z3ds = function(bet, kj) {}
    // 任三组六单式
exports.rx3z6ds = function(bet, kj) {}
    // 任选二组选复式
...
exports.bdw4x2qm = function(bet, kj) {
        kj = filterArray(kj.substr(0, 7).split(','));
        bet = bet.split(' ');
        if (bet.length < kj.length) {
            if (Sames(kj, bet) >= 2) return Combination(Sames(kj, bet), 2);
        } else if (bet.length >= kj.length) {
...
// 三星复式
exports.sslH3f = function(bet, kj) {
    return fs(bet, kj);
}

// 三星单式
exports.sslH3d = function(bet, kj) {
    return ds(bet, kj);
}

//三星直选和值
exports.sslH3hz = function(bet, kj) {
	var k = 0;
	kj = kj.split(',');
	bet = bet.split(',');
	var m = (parseInt(kj[0]) + parseInt(kj[1]) + parseInt(kj[2]));
...
// 三星组三
exports.sslH3z3 = function(bet, kj) {
    return z3(bet, kj);
}

// 三星组六
exports.sslH3z6 = function(bet, kj) {
    return z6(bet, kj);
}

// 三星组3和值
exports.sslz3H3hz = function(bet, kj) {
	kj = kj.split(',');
	bet = bet.split(',');
	var bz = kj.join();
	if (bz.match(/(\d),\1,\1/)) return 0;
...
// 三星组6和值
exports.sslz6H3hz = function(bet, kj) {
	kj = kj.split(',');
	bet = bet.split(',');
	var bz = kj.join();
	if (bz.match(/(\d),\1,\1/)) return 0;
...
// 前二复式
exports.sslQ2f = function(bet, kj) {
    return fs(bet, kj.substr(0, 3));
}

// 后二复式
exports.sslH2f = function(bet, kj) {
    return fs(bet, kj.substr(2,3));
}

// 前二组复式
exports.sslzxQ2f = function(bet, kj) {
    return z2f(bet, kj.substr(0, 3));
}

// 后二组复式
exports.sslzxH2f = function(bet, kj) {
    return z2f(bet, kj.substr(2,3));
}

// 前二大小单双
exports.ssldsQ2 = function(bet, kj) {
    return dxds(bet, kj.substr(0, 3));
}

// 后二大小单双
exports.ssldsH2 = function(bet, kj) {
...
exports.gd11x5Q3zd = function(bet, kj) {
    return z2d(bet, kj.substr(0, 8));
}
// 中三直选
exports.gd11x5Z3 = function(bet, kj) {
    return qs(bet, kj.substr(3,8), 100);
}
// 中三组选
...
exports.gd11x5Z3zd = function(bet, kj) {
    return z2d(bet, kj.substr(3,8));
}
// 后三直选
exports.gd11x5H3 = function(bet, kj) {
    return qs(bet, kj.substr(6,8), 100);
}
// 后三组选
exports.gd11x5H3z = function(bet, kj) {
...
// 不定位(中三位)
exports.gd11x5bdwz = function(bet, kj) {
    kj = kj.substr(3, 8).split(',');
    bet = bet.split(' ');
    return Sames(bet, kj);
}
// 不定位(后三位)
exports.gd11x5bdwh = function(bet, kj) {
    kj = kj.substr(6, 8).split(',');
    bet = bet.split(' ');
    return Sames(bet, kj);
}
...
exports.k32fx = function(bet, kj) {
    bet = bet.replace(/\*/g, "").replace(/\ /g, "").split('');
    kj = kj.split(',');
    if (Sames(kj, bet) == 2) {
        return 1;
    } else {
...
exports.pcddtm = function(bet, kj) {
    var kj = kj.split(',');
    kj = Math.abs(kj[0]) + Math.abs(kj[1]) + Math.abs(kj[2]);
    if (bet == kj) {
        return 1;
    } else {
        return 0;
...
exports.pcdddddsxdxs = function(bet, kj) {
    ...
    switch (bet) {
        case "大双":
            return (kj >= 14 && kj <= 27 && kj % 2 === 0) ? 1 : 0;
            break;
        case "大单":
            return (kj >= 14 && kj <= 27 && kj % 2 === 1) ? 1 : 0;
            break;
        case "小双":
            return (kj >= 0 && kj <= 13 && kj % 2 === 0) ? 1 : 0;
            break;
        case "小单":
            return (kj >= 0 && kj <= 13 && kj % 2 === 1) ? 1 : 0;
            break;
        default:
            return 0;
    }
...
exports.pcddjxjd = function(bet, kj) {
    ...
    switch (bet) {
        case "极大":
            return Sames([kj], [22, 23, 24, 25, 26, 27]);
            break;
        case "极小":
            return Sames([kj], [0, 1, 2, 3, 4, 5]);
            break;
        default:
            return 0;
    }
...
exports.pcddbs = function(bet, kj) {
    ...
    switch (bet) {
        case "绿波":
            return Sames([kj], [1, 4, 7, 10, 16, 19, 22, 25]);
            break;
        case "蓝波":
            return Sames([kj], [2, 5, 8, 11, 17, 20, 23, 26]);
            break;
        case "红波":
            return Sames([kj], [3, 6, 9, 12, 15, 18, 21, 24]);
            break;
        default:
            return 0;
    }
...
exports.pcddbz = function(bet, kj) {
    var kj = kj.split(',');
    if (bet === "豹子" && kj[0] - kj[1] === kj[0] - kj[2] && kj[0] - kj[1] === 0) {
        return 1;
    }
    return 0;
}
...
/*平码*/
exports.LHCZTM = function(bet,kj){
	bet = bet.split("_");
	var idx = bet[0];
	var count =0;
	bet = bet[1];
...
/*平码 大小单双合单合双*/
exports.LHCZTMDXDS = function(bet,kj){
	bet = bet.split("_");
	var idx = bet[0];
	bet = bet[1];
    kj = kj.split(',');
	...
	switch(bet){
		...
		break;
		case "合单":
			kj = kj[parseInt(idx)+1];
			kj = parseInt(kj[0]) + parseInt(kj[1]);
			if(kj%2===1){
				return 1;
			}
		break;
...
/*平码 波色*/
exports.LHCZTMBS = function(bet,kj){
	bet = bet.split("_");
	var idx = bet[0];
	bet = bet[1];
    kj = kj.split(',');
...
/*五行*/
exports.LHCWUXING = function(bet,kj){
	var data = {
...
/*正肖*/
exports.LHCZHENGXIAO = function(bet,kj){
	var count =0;
	var data={
		"鼠":"10,22,34,46",
		"马":"04,16,28,40",
    ...
    kj = kj.split(',');
	kj.pop();
	kj.forEach(function(v){
		if(kj[bet].indexOf(v)!==-1){
			count++;
		}
	});
	return count;
...
/*七色波*/
exports.LHCQIBOSE = function(bet,kj){
	var counter = {
		"红波" : 0,
		"绿波" : 0,
		"蓝波" : 0
	...
	kj.forEach(function(v){
		if(CheckCLR(v,"红波")){
			counter["红波"] = counter["红波"] + 1;
		}
		if(CheckCLR(v,"绿波")){
			counter["绿波"] = counter["绿波"] + 1;
		}
		if(CheckCLR(v,"蓝波")){
			counter["蓝波"] = counter["蓝波"] + 1;
		}
	});
	[tm].forEach(function(v){
		if(CheckCLR(v,"红波")){
			counter["红波"] = counter["红波"] + 1.5;
		}
		if(CheckCLR(v,"绿波")){
			counter["绿波"] = counter["绿波"] + 1.5;
		}
		if(CheckCLR(v,"蓝波")){
			counter["蓝波"] = counter["蓝波"] + 1.5;
		}
	});
	if((counter["红波"]===3 && counter["绿波"]===3)||
		(counter["蓝波"]===3 && counter["绿波"]===3)||
		(counter["红波"]===3 && counter["蓝波"]===3)){
		flag = 0; //和局
	}else if(
		(counter["红波"] > counter["绿波"]) &&
		(counter["红波"] > counter["蓝波"])){
		flag = 1; //红波
	}else if(
		(counter["绿波"] > counter["红波"]) &&
		(counter["绿波"] > counter["蓝波"])){
		flag = 2; //绿波
	}else if(
		(counter["蓝波"] > counter["红波"]) &&
		(counter["蓝波"] > counter["绿波"])){
		flag = 3; //蓝波
	}
	if(bet==="红波" && flag===1){
		return 1;
	}else if(bet==="绿波" && flag===2){
		return 1;
	}else if(bet==="蓝波" && flag===3){
		return 1;
	}else if(bet==="和局" && flag===0){
		return 1;
	}
	return 0;
}
/*总肖*/
exports.LHCZONGXIAO = function(bet,kj){
	var flag = {};
	var counter=0;
    kj = kj.split(',');
	kj.forEach(function(v){
		["鼠","马","牛","羊","虎","鸡","兔","猴","龙","狗","蛇","猪"].forEach(function(vv){
			if(CheckANM(vv,v)){
				flag[vv] = true;
			}
		});
...
/*总肖单双*/
exports.LHCZONGXIAODS = function(bet,kj){
	var flag = {};
	var counter=0;
    kj = kj.split(',');
	kj.forEach(function(v){
	...
	for(i in counter)
		counter++;
	if(bet==="总肖单" && counter%2===1){
		return 1;
	}
	if(bet==="总肖双" && counter%2===0){
		return 1;
	}
	return 0;
}
